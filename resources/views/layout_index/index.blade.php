...
<section class="wrapper bg-light">
	...
	<div class="row gx-lg-8 gx-xl-12 gy-8 mb-14 mb-md-17" data-cues="slideInUp" data-group="services">
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/target.svg') }}" class="svg-inject icon-svg icon-svg-sm text-aqua me-4" alt="" />
			</div>
			<div>
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/medal.svg') }}" class="svg-inject icon-svg icon-svg-sm text-yellow me-4" alt="" />
			</div>
			<div>
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/clock-3.svg') }}" class="svg-inject icon-svg icon-svg-sm text-red me-4" alt="" />
			</div>
			<div>
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/check.svg') }}" class="svg-inject icon-svg icon-svg-sm text-pink me-4" alt="" />
			</div>
			<div>
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/shop-2.svg') }}" class="svg-inject icon-svg icon-svg-sm text-green me-4" alt="" />
			</div>
			<div>
		...
		<div class="d-flex flex-row">
			<div>
			<img src="{{ asset('dev/img/icons/team.svg') }}" class="svg-inject icon-svg icon-svg-sm text-purple me-4" alt="" />
			</div>
			<div>
...
<section class="wrapper bg-soft-primary">
	...
	<div class="row">
		...
		<div class="mt-lg-n20 mt-xl-n22 mb-14 mb-md-16 position-relative light-gallery-wrapper" data-cue="slideInUp">
			...
			<figure class="rounded shadow"><img src="{{ asset('dev/img/photos/v1.jpg') }}" srcset="{{ asset('dev/img/photos/v1@2x.jpg') }} 2x" alt=""></figure>
		</div>
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					...
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te7.jpg') }}" srcset="{{ asset('dev/img/avatars/te7@2x.jpg') }} 2x" alt="" />
					<div class="info">
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
					<div class="blockquote-details">
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te8.jpg') }}" srcset="{{ asset('dev/img/avatars/te8@2x.jpg') }} 2x" alt="" />
					<div class="info">
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
					<div class="blockquote-details">
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te9.jpg') }}" srcset="{{ asset('dev/img/avatars/te9@2x.jpg') }} 2x" alt="" />
					<div class="info">
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
					<div class="blockquote-details">
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te10.jpg') }}" srcset="{{ asset('dev/img/avatars/te10@2x.jpg') }} 2x" alt="" />
					<div class="info">
						<h5 class="mb-0">Coriss Ambady</h5>
						<p class="mb-0">Financial Analyst</p>
					</div>
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
					<div class="blockquote-details">
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te11.jpg') }}" srcset="{{ asset('dev/img/avatars/te11@2x.jpg') }} 2x" alt="" />
					<div class="info">
		...
		<div class="item">
			...
			<div class="card">
				...
				<blockquote class="icon mb-0">
					<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
					<div class="blockquote-details">
					<img class="rounded-circle w-12" src="{{ asset('dev/img/avatars/te12.jpg') }}" srcset="{{ asset('dev/img/avatars/te12@2x.jpg') }} 2x" alt="" />
					<div class="info">
